...
<main>
    ...
    <form name="arcraft_view" action="." method="" id="aircraft_view" class="aligned">
        ...
        <input type="text" name="left_engine" readonly size="4" value="<?= $aircraft['EL'];?>"/>
        <br/>
        <label>Hours to next service <strong>(Right Engine)</strong>:</label>
        <input type="text" name="right_engine" readonly size="4" value="<?= $aircraft['ER'];?>"/>
        <br/>
        <label>Hours to next major inspection <strong>(Air Frame)</strong>:</label>
        <input type="text" name="air_frame" readonly size="4" value="<?= $aircraft['AF'];?>"/>
        <br/>
        <label>Average Fuel Consumption per Charter:</label>
        <input type="text" name="avg_fuel" readonly size="4" value="<?= $aircraft['FUEL'];?>"/>
        <br/>
        <label>Average Oil Consumption per Charter:</label>
        <input type="text" name="avg_oil" readonly size="4" value="<?= $aircraft['OIL'];?>"/>
        <br/>
    </form>
    <p class="">
